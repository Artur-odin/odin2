...
ball = canvas.create_oval(190, 200, 210, 220, fill="yellow")
...
for r in range(4):
    for c in range(8):
        blocks.append(canvas.create_rectangle(c*50, r*30, c*50+45, r*30+25, fill="green"))
def move_padle(event):
